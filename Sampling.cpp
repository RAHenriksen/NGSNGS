    ...
    */
    ...
    if (SE==struct_obj->SeqType){
      if (strandR1 == 0){
        ...
        if (seq_r1[0]=='G'||seq_r1[0]=='g'){G_total++;}
	      SamFlags[0] = 0;
      }
      else if (strandR1 == 1){
        SamFlags[0] = 16;
        ...
        if (seq_r1[0]=='G'||seq_r1[0]=='g'){G_total_rev++;}
      }
    }
    if (PE==struct_obj->SeqType){
      if (strandR1 == 0){
